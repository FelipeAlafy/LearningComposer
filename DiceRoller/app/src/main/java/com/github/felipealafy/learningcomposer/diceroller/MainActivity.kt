...
fun DiceRollerWithButtonAndImage(modifier: Modifier = Modifier
    ...
    Column(modifier = modifier.wrapContentSize(align = Alignment.Center), horizontalAlignment = Alignment.CenterHorizontally) {
        ...
        Image(painter = painterResource(id = imageResource), contentDescription = currentDice.toString())
        Spacer(modifier = Modifier.height(16.dp))
        Button(onClick = { currentDice = (1..6).random() }) {
